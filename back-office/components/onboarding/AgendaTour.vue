...
const STORAGE_KEY = 'instalapro_backoffice_tour_agenda_seen'
...
const buildSteps = () => {
  ...
  const definitions = [
    {
      selector: '[data-tour-id="schedule-new-job-button"]',
      title: 'Nuevo Trabajo',
      description: 'Creá rápidamente un nuevo trabajo programado para un cliente.',
      side: 'bottom',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    },
    {
      selector: '[data-tour-id="schedule-view-mode-toggle"]',
      title: 'Modo de Vista',
      description: 'Alternando entre ver tus trabajos programados y gestionar tu disponibilidad horaria.',
      side: 'bottom',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    },
    {
      selector: '[data-tour-id="schedule-weekly-timeline"]',
      title: 'Agenda Semanal',
      description: 'Visualizá todos tus trabajos de la semana en un calendario interactivo.',
      side: 'top',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    },
    {
      selector: '[data-tour-id="schedule-availability-grid"]',
      title: 'Configurar Disponibilidad',
      description: 'Abrí o cerrá horarios para nuevas reservas según tu disponibilidad real.',
      side: 'top',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    }
...
const startTour = async (force = false) => {
  ...
  try {
    const selectors = [
      ...
      '[data-tour-id="schedule-weekly-timeline"]'
    ]
...
const tryAutoLaunch = async () => {
  ...
  if (!authStore.initialized || !authStore.isTestUser || route.path !== '/schedule' || hasSeenTour) {
