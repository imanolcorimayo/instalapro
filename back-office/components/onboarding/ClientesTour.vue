...
const STORAGE_KEY = 'instalapro_backoffice_tour_clientes_seen'
...
const buildSteps = () => {
  ...
  const definitions = [
    {
      selector: '[data-tour-id="clients-add-button"]',
      title: 'Agregar Cliente',
      description: 'Creá nuevos registros de clientes con su información de contacto y dirección.',
      side: 'bottom',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    },
    {
      selector: '[data-tour-id="clients-search-bar"]',
      title: 'Buscar Clientes',
      description: 'Buscá rápidamente por nombre, teléfono o dirección para encontrar cualquier cliente.',
      side: 'bottom',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    },
    {
      selector: '[data-tour-id="clients-card-example"]',
      title: 'Ficha de Cliente',
      description: 'Cada tarjeta muestra información clave, historial de trabajos y total gastado.',
      side: 'top',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    },
    {
      selector: '[data-tour-id="clients-whatsapp-action"]',
      title: 'Contacto por WhatsApp',
      description: 'Contactá directamente a tus clientes por WhatsApp con un solo click.',
      side: 'bottom',
      mobileSide: 'bottom',
      mobileAlign: 'center'
    }
...
const startTour = async (force = false) => {
  ...
  try {
    const selectors = [
      ...
      '[data-tour-id="clients-search-bar"]'
    ]
...
const tryAutoLaunch = async () => {
  ...
  if (!authStore.initialized || !authStore.isTestUser || route.path !== '/clients' || hasSeenTour) {
